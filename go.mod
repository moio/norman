...
replace github.com/rancher/lasso => github.com/moio/lasso v0.0.0-20230908143834-8175db085768

replace github.com/rancher/wrangler => github.com/moio/wrangler v0.0.0-20230908143931-900ab5b6d6b7
